...
data.raw["fusion-reactor"]["fusion-reactor"].maraxsis_buildability_rules = {water = false, dome = true, coral = false, trench = false, trench_entrance = false, trench_lava = false}
data.raw["fusion-generator"]["fusion-generator"].maraxsis_buildability_rules = {water = false, dome = true, coral = false, trench = false, trench_entrance = false, trench_lava = false}
