...
set_default_import_location("maraxsis-reinforced-glass", "maraxsis")
set_default_import_location("maraxsis-fish-food", "maraxsis")
set_default_import_location("maraxsis-tropical-fish", "maraxsis")
set_default_import_location("microplastics", "maraxsis")
set_default_import_location("maraxsis-ooozma-specimen", "maraxsis")
set_default_import_location("maraxsis-ooozma-confinement-cell", "maraxsis")
...
set_default_import_location("brackish-water-barrel", "maraxsis")
set_default_import_location("saline-water-barrel", "maraxsis")
...
set_default_import_location("maraxsis-geothermal-generator", "maraxsis")
