...
if not mods['Krastorio2'] then
    function furnacekpipepictures_a()
        return {
            ...
            east = {
                filename = path .. '/advanced-furnace-k-pipe-E-top.png',
                priority = 'extra-high',
                width = 30, --20,
                height = 38,
            ...
            south = {
                filename = path .. '/advanced-furnace-k-pipe-S-right.png',
                priority = 'extra-high',
                width = 44,
                height = 31,
            ...
            west = {
                filename = path .. '/advanced-furnace-k-pipe-W-bottom.png',
                priority = 'extra-high',
                width = 19,
                height = 37,
    ...
    function furnacekpipepictures_b()
        return {
            ...
            east = {
                filename = path .. '/advanced-furnace-k-pipe-E-bottom.png',
                priority = 'extra-high',
                width = 38, --20,
                height = 38,
            ...
            south = {
                filename = path .. '/advanced-furnace-k-pipe-S-left.png',
                priority = 'extra-high',
                width = 44,
                height = 31,
                shift = util.by_pixel(0, -31.5),
            ...
            west = {
                filename = path .. '/advanced-furnace-k-pipe-W-top.png',
                priority = 'extra-high',
                width = 19,
                height = 42, --37,
...
local animation = {
    layers = {
        {
            filename = path .. '/advanced-furnace.png',
            priority = 'high',
            width = 240,
            height = 240,
            shift = {0, -0.1},
        ...
        {
            filename = path .. '/advanced-furnace-sh.png',
            priority = 'high',
            scale = scale,
            width = 83,
            height = 240,
...
local working_visualizations = {
    {
        constant_speed = true,
        animation = {
            filename = path .. '/advanced-furnace-anim-light.png',
            priority = 'high',
            width = 240,
            height = 240,
            shift = {0, -0.1},
    ...
    },
    {
        constant_speed = true,
        animation = {
            filename = path .. '/advanced-furnace-anim-glow.png',
            priority = 'high',
            width = 240,
            height = 240,
            shift = {0, -0.1},
    ...
    },
    {
        constant_speed = true,
        animation = {
            filename = path .. '/advanced-furnace-anim.png',
            priority = 'high',
            width = 240,
            height = 240,
            shift = {0, -0.1},
...
data:extend {{
    ...
    fluid_boxes = {
        ...
        },
        {
            ...
            base_area = 10,
            base_level = 0,
            pipe_connections = {{type = 'input-output', position = {4, -1}}, {type = 'input-output', position = {-4, -1}}},
            secondary_draw_orders = {north = -1},
        },
        {
