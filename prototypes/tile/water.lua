...
local waterifiy = {
    ...
    tile = function(tile, include_submarine_exclusion_zone)
        ...
        tile.map_color = py.color_combine(tile.map_color or data.raw.tile['water'].map_color, data.raw.tile['deepwater'].map_color, 0.25)
    ...
    entity = function(entity)
        ...
        ---@diagnostic disable-next-line: param-type-mismatch
        underwater.map_color = py.color_combine(underwater.map_color or data.raw.tile['water'].map_color, data.raw.tile['deepwater'].map_color, 0.25)
