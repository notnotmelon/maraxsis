...
i_want_to_fit_this_many_per_rocket("maraxsis-reinforced-glass", 500)
i_want_to_fit_this_many_per_rocket("maraxsis-fish-food", 100)
i_want_to_fit_this_many_per_rocket("maraxsis-tropical-fish", 100)
i_want_to_fit_this_many_per_rocket("microplastics", 1000)
i_want_to_fit_this_many_per_rocket("maraxsis-ooozma-specimen", 20)
i_want_to_fit_this_many_per_rocket("maraxsis-ooozma-confinement-cell", 20)
...
i_want_to_fit_this_many_per_rocket("maraxsis-geothermal-generator", 5)
