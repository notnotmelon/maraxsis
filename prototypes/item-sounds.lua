...
add_sound_item("maraxsis-torpedo", item_sounds.ammo_large_inventory_move, item_sounds.ammo_large_inventory_pickup, item_sounds.ammo_large_inventory_move)
add_sound_item("maraxsis-explosive-torpedo", item_sounds.ammo_large_inventory_move, item_sounds.ammo_large_inventory_pickup, item_sounds.ammo_large_inventory_move)
add_sound_item("maraxsis-atomic-torpedo", item_sounds.atomic_bomb_inventory_move, item_sounds.atomic_bomb_inventory_pickup, item_sounds.atomic_bomb_inventory_move)
