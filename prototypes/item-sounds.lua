...
add_sound_item(maraxsis_constants.SAND_ITEM_NAME, item_sounds.resource_inventory_move, item_sounds.resource_inventory_pickup, item_sounds.resource_inventory_move)
...
add_sound_item("maraxsis-goozma-specimen", item_sounds.raw_fish_inventory_move, item_sounds.raw_fish_inventory_pickup, item_sounds.raw_fish_inventory_move)
add_sound_item("maraxsis-goozma-confinement-cell", item_sounds.metal_small_inventory_move, item_sounds.metal_small_inventory_pickup, item_sounds.metal_small_inventory_move)
