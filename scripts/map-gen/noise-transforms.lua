...
transforms.rotate_x = function(x, y, tile, map)
	local sin = h2o2.get_noise_constant(2)
	local cos = h2o2.get_noise_constant(3)
...
transforms.noise_strech_x = function(x, y, tile, map)
	seed = seed + 4461
	local shiftx_1 = tne(h2o2.basis_noise(x, y, seed, tne(30)))
	seed = seed + 4461
	local shiftx_2 = tne(h2o2.basis_noise(x, y, seed, tne(15)))
...
transforms.factorize_x = function(x, y, tile, map)
	local factor = tne(200) * tne(0.03) ^ (1.3 + tne(h2o2.basis_noise(x, y, 774432, tne(256))))
	local powx = tne(h2o2.basis_noise(x, y, 115123, tne(128)))
	local powy = tne(h2o2.basis_noise(x, y, 9271995, tne(128)))
